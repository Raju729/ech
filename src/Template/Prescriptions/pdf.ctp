                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="row text-center" >
                                                <div class="col-sm-2 pt-20">
                                                    <img src="<?= $this->request->getAttribute("webroot") ?>img/public/logo-wide.png" alt="">
                                                </div>
                                                <div class="col-sm-8">
                                                    <h3 class="mb-0">HHH TELEMEDICINE PROGRAMME</h3>
                                                    Organized by PQS Network Ltd.<br>
                                                ...
                                                <div class="col-sm-1">
                                                    <h3><i style="color:#2570bb;" class="fa fa-download" aria-hidden="true"></i></h3>
                                                </div>
                                            </div>
